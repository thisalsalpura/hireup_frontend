        ...
        <section className="bg-white h-full">
            <div className="max-w-7xl mx-auto h-full bg-white">
                <div className="relative h-full w-full grid grid-cols-12">
                    {!isOpen && (
                        <>
                            <div className={`relative overflow-hidden h-full w-full hidden lg:flex lg:col-span-7 items-center justify-center p-3 ${!isOpen ? "top-0" : "top-[-100%]"} transition-all duration-300 ease-in-out`}>
                            ...
                            <div className={`relative h-full w-full flex col-span-12 lg:col-span-5 items-center justify-center p-4 sm:p-6 ${!isOpen ? "top-0" : "top-[-100%]"} transition-all duration-300 ease-in-out`}>
                                <div className="h-full w-full flex flex-col bg-cus-black-low rounded-xl shadow-xl border border-black p-5 sm:p-8">
                                    ...
                                    <p className="text-white text-sm sm:text-base tracking-wide mt-4">Not registered? <a className="text-blue-700" onClick={toggleSlide}>Create account</a></p>
