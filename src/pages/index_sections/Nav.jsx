    ...
    const navItems = () => {
        return (
            <div className="flex flex-col items-center gap-5">
                <Button href="/userLogin" name="Register" frontClasses="text-black h-10 w-40 border-2 border-black" backClasses="h-10 w-40 bg-cus-light-yellow-high" />
                <Button href="/userLogin" name="SignIn" frontClasses="text-white h-10 w-40 border-2 border-black" backClasses="h-10 w-40 bg-cus-dark-purple" />
            </div>
        )
    }
